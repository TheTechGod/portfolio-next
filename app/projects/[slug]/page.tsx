...
export default async function ProjectDetail({
  ...
  const sections: Record<
    string,
    { ctx: string; role: string; tech: string[]; highlights: string[] }
  > = {
    "mini-crm": {
  ...
  return (
    <div className="container section">
      <a href="/projects" className="btn btn-sm btn-outline-secondary mb-3">
        ← Back to Projects
      </a>
      ...
      <div className="mb-3">
        {s.tech.map((t) => (
          <span key={t} className="badge text-bg-light me-1">
            {t}
          </span>
        ))}
      </div>
